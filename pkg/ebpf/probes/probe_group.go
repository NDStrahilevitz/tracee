...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool, defaultAutoload bool, binaryPath string) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		SyscallTableCheck:          NewFixedUprobe(Uprobe, "uprobe_syscall_table_check", binaryPath, UprobeEventSymbol("github.com/aquasecurity/tracee/pkg/ebpf.(*Tracee).triggerSyscallTableIntegrityCheckCall")),
		HiddenKernelModuleSeeker:   NewFixedUprobe(Uprobe, "uprobe_lkm_seeker", binaryPath, UprobeEventSymbol("github.com/aquasecurity/tracee/pkg/ebpf.(*Tracee).triggerKernelModuleSeeker")),
		HiddenKernelModuleVerifier: NewFixedUprobe(Uprobe, "uprobe_lkm_seeker_submitter", binaryPath, UprobeEventSymbol("github.com/aquasecurity/tracee/pkg/ebpf.(*Tracee).triggerKernelModuleSubmitter")),
		PrintNetSeqOps:             NewFixedUprobe(Uprobe, "uprobe_seq_ops_trigger", binaryPath, UprobeEventSymbol("github.com/aquasecurity/tracee/pkg/ebpf.(*Tracee).triggerSeqOpsIntegrityCheckCall")),
		PrintMemDump:               NewFixedUprobe(Uprobe, "uprobe_mem_dump_trigger", binaryPath, UprobeEventSymbol("github.com/aquasecurity/tracee/pkg/ebpf.(*Tracee).triggerMemDumpCall")),
		...
		IoSubmitSqeIoWrite:         NewTraceProbe(KProbe, "__io_submit_sqe", "trace__io_submit_sqe_io_write"),
		...
		IoWriteMagic:               NewTraceProbe(KProbe, "io_write", "io_write_magic_enter"),
		IoWriteMagicRet:            NewTraceProbe(KretProbe, "io_write", "io_write_magic_return"),
