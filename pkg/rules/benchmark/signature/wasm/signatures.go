...
func NewSignature(metadata detect.SignatureMetadata, selector []detect.SignatureEventSelector, filters []protocol.Filter, regoCodes []string) (detect.Signature, error) {
...
func (s *signature) GetFilters() ([]protocol.Filter, error) {
