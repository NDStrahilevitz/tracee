...
func LessEqFilter(field string, vals ...interface{}) Filter {
...
func GreatEqFilter(field string, vals ...interface{}) Filter {
...
func PrefixFilter(field string, prefixes ...string) Filter {
	...
	return Filter{field, Equal, prefixVals}
}
...
func SuffixFilter(field string, suffixes ...string) Filter {
	...
	return Filter{field, Equal, suffixVals}
}
...
func ContainsFilter(field string, contains ...string) Filter {
	...
	return Filter{field, Equal, containedVals}
}
